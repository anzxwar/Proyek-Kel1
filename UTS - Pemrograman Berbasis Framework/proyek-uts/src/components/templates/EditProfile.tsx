...
const EditProfile = () => {
    return (
        <div>
            <div className="card rounded-lg p-8 flex flex-col items-left bg-white gap-8 mt-1">
                ...
                <div className="grid grid-cols-3 gap-auto">
                    ...
                    <div className="col-span-1 space-y-3">
                        <div className="mb-1">
                            ...
                            <input type="text" id="name" name="name" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Indira Seruni" />
                        </div>
                        <div className="mb-1">
                            <label htmlFor="email" className="font-bold mb-1 block">Email</label>
                            <input type="email" id="email" name="email" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="indira@gmail.com" />
                        </div>
                        <div className="mb-1">
                            <label htmlFor="date" className="font-bold mb-1 block">Date of Birth</label>
                            <input type="date" id="date" name="date" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Enter your date" />
                        </div>
                        <div className="mb-1">
                            <label htmlFor="address" className="font-bold mb-1 block">Permanent Address</label>
                            <input type="address" id="address" name="address" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Purwosari, Pasuruan, Jawa Timur" />
                        </div>
                        <div className="mb-1">
                            <label htmlFor="telegram" className="font-bold mb-1 block">Telegram Username</label>
                            <input type="telegram" id="telegram" name="telegram" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Indira12" />
                        </div>
                    ...
                    <div className="col-span-1 space-y-3">
                        <div className="mb-1">
                            ...
                            <input type="user" id="user" name="user" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Indira Seruni" />
                        </div>
                        <div className="mb-1">
                            <label htmlFor="password" className="font-bold mb-1 block">Password</label>
                            <input type="password" id="password" name="password" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="*********" />
                        </div>
                        <div className="mb-1">
                        ...
                        <div className="mb-1">
                            ...
                            <input type="city" id="city" name="city" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Jakarta" />
                        </div>
                        <div className="mb-1">
                            <label htmlFor="Country" className="font-bold mb-1 block">Country Username</label>
                            <input type="Country" id="Country" name="Country" className="p-1 border border-gray-300 rounded-md w-4/5" placeholder="Indonesia" />
                        </div>
